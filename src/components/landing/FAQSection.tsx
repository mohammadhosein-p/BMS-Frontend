...
const faqItems = [
    ...
    {
        question:
            "آیا اپلیکیشن موبایل آپارمو در دسترس است؟",
        answer: "در حال حاضر وبسایت آپارمو فعال است. به زودی اپلیکیشن موبایل نیز آماده خواهد شد",
    },
    {
        question: "کارت اعتباری ندارم، چطور سرویس را خریداری کنم؟",
        answer: "می توانید از طریق ارتباط با ادمین خرید تان را با ارز های دیجیتال نیز انجام دهید",
    },
    {
        question: "آیا امکان بازگشت وجه دارد؟",
        answer: "بله، در صورت عدم رضایت از سرویس تا یک هفته ضمانت بازگشت وجه وجود دارد",
    },
];
