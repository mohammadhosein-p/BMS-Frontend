  ...
  return (
    <>
      <div className="flex flex-row gap-2 bg-white shadow-lg rounded-2xl overflow-hidden">
        <div className={`w-5 ${orderColorMap[announcement.order]}`} />
        ...
        <div className="flex flex-col gap-1 px-4 py-2 flex-1">
          ...
          <p className="text-gray-600 line-clamp-1">{announcement.body}</p>
          <p className="text-sm text-gray-500">{new Date(announcement.created_at).toLocaleDateString("fa-IR")}</p>
        </div>
